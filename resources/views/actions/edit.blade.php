    ...
    <div class="card-body">
      <form action="{{ route('actions.update', $action->id) }}" method="POST">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-10">
            <input type="text" name="action" value="{{ $action->action }}" class="form-control" id="basic-default-action" placeholder="Nama Tindakan" />
          </div>
        </div>
        <div class="row mb-3">
          <label class="col-sm-2 col-form-label" for="basic-default-code">Kode ICD</label>
          <div class="col-sm-10">
            <input type="text" name="code_icd" value="{{ $action->code_icd }}" class="form-control" id="basic-default-code" placeholder="Kode ICD" />
          </div>
        </div>
        <div class="row mb-3">
          <label class="col-sm-2 col-form-label" for="basic-default-price">Harga</label>
          <div class="col-sm-10">
            <input type="number" name="price" value="{{ $action->price }}" class="form-control" id="basic-default-price" placeholder="Harga Tindakan" />
          </div>
        </div>
